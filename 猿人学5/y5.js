...
function _0x1ee7ec(ti) {

    ti = unescape(encodeURIComponent(ti))
    // console.log(_0x35f5f2(ti))

    // console.log(_0x12b47d(_0x11a7a2(_0x35f5f2(ti), 0x8 * 13)))
    // console.log((_0x11a7a2(_0x35f5f2(ti), 0x8 * 13)))
    // console.log(ti)
    // [ 808597297, 875837232, 808466744, 48 ]
    // console.log("SB", _0x11a7a2(_0x35f5f2(ti), 8 * 13))

    return _0x12b47d(_0x11a7a2(_0x35f5f2(ti), 0x8 * 13));
}
...
function _0x474032(ti) {
    // console.log(_0x499969(_0x1ee7ec(ti)))
    return _0x499969(_0x1ee7ec(ti));
}
...
_0x4e96b4['btoa'] = function btoa(utf8Str) {
...
function get_ss(_$yw) {
    ...
    for (var i = 1; i <= 4; i++) {
        _$Wa = _0x12eaf3();
        var sb = _0x474032(_$Wa)
        _0x4e96b4['_$pr']['push'](sb);
        console.log(sb)
    }

    mm = _0x474032(_$yw)
    _0x3d0f3f['cookie'] = 'm=' + mm + ';\x20path=/';
    _0x4e96b4['_$is'] = _$yw;
    _0x4e96b4['_$pr']['push'](mm);

    // console.log(_0x4e96b4['_$pr'])

    _$Tk = require("crypto-js");
    ...
    return _0x4e96b4['_$ss']
}

function get_config() {
    _$yw = new Date()['valueOf']()['toString']();

    let r_r = 'R' + 'M' + '4' + 'h' + 'Z' + 'B' + 'v' + '0' + 'd' + 'D' + 'o' + 'n' + '4' + '4' + '3' + 'M=';
